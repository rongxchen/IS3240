  ...
  methods: {
    ...
    updateTreeData: function updateTreeData() {
      ...
      if (keys.length) {
        ...
        // 合并 expanded 与 display.html，确保数据刷新后，状态不变
        keys.forEach(function (key) {
...
/* harmony default export */ var table_body = ({
  ...
  methods: {
    ...
    rowRender: function rowRender(_ref4) {
      ...
      // 指令 v-show 会覆盖 row-style 中 display.html
        ...
        if (cur) {
          ...
          var traverse = function traverse(children, parent) {
            ...
            children.forEach(function (node) {
              // 父节点的 display.html 状态影响子节点的显示状态
              ...
              // 对于它子节点的 display.html 属性由它本身的 expanded 与 display.html 共同决定。
              if (cur) {
          ...
          // 对于 root 节点，display.html 一定为 true
          cur.display = true;
